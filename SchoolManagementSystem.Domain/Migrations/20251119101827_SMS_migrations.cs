...
{
    /// <inheritdoc />
    public partial class SMS_migrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Classes_ClassBatchId",
                        column: x => x.ClassBatchId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assignments_Users_MarkedByTeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendance_Classes_ClassBatchId",
                        column: x => x.ClassBatchId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendance_Users_MarkedByTeacherId",
                        column: x => x.MarkedByTeacherId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentClasses_Classes_ClassBatchId",
                        column: x => x.ClassBatchId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_ClassBatchId",
                table: "Assignments",
                column: "ClassBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_MarkedByTeacherId",
                table: "Assignments",
                column: "MarkedByTeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendance_ClassBatchId",
                table: "Attendance",
                column: "ClassBatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentClasses_ClassBatchId",
